            ...
            <div className="order-2 md:order-1">
              <div className="border-l-4 border-[#c4504a] pl-6">
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    お客様との出会いは私たちにとって新たな物語の始まりです。それぞれのお客様のビジョンを理解し、共に創造する過程は私たちにとって大きなやりがいであり、誇りです。
                  </p>
                  <p className="text-gray-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <form className="space-y-6 bg-white p-8 border-2 border-[#d4c5b0] relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <input type="text" className="w-full px-4 py-3 border-2 border-[#d4c5b0] bg-[#f5f2ed] focus:outline-none focus:border-[#c4504a] transition-colors" placeholder="山田 太郎" />
              </div>
              <div className="relative">
                <label className="block mb-2 tracking-wider">メールアドレス</label>
                <input type="email" className="w-full px-4 py-3 border-2 border-[#d4c5b0] bg-[#f5f2ed] focus:outline-none focus:border-[#c4504a] transition-colors" placeholder="example@email.com" />
              </div>
              <div className="relative">
                <label className="block mb-2 tracking-wider">お問い合わせ内容</label>
                <textarea rows={5} className="w-full px-4 py-3 border-2 border-[#d4c5b0] bg-[#f5f2ed] focus:outline-none focus:border-[#c4504a] transition-colors" placeholder="ご相談内容をご記入ください" />
              </div>
      ...
      <footer className="bg-[#3a3230] text-[#f5f2ed] py-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-center text-sm text-gray-400 max-w-md leading-relaxed">
              想いをカタチに、笑顔をそばに、繋がりを大切に
            </p>
